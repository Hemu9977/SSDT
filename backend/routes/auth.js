...
// An account is blocked if the user themselves was disabled by an admin,
// or if their organization was disabled.
...
// Explicit OPTIONS handler — belt-and-suspenders in case the global
// preflight handler in server.js is bypassed.
...
router.post('/register', async (req, res) => {
  ...
  try {
    ...
    // Seed the email language from the UI language
    // the visitor registered under.
